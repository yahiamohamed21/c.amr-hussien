    ...
    <section id="mission" ref={containerRef} className="relative bg-[#F2F0E9] dark:bg-[#10110F] transition-colors duration-500 border-t border-[#10110F]/5 dark:border-white/5">
      ...
      <div className="max-w-[1600px] mx-auto w-full flex flex-col lg:flex-row relative">
          ...
          <div className="w-full lg:w-1/2 py-10 lg:py-40 px-6 md:px-16 flex flex-col gap-8 lg:gap-24 relative z-20">
              ...
              {/* Card 2 */}
              <div className="mission-card w-full aspect-square sm:aspect-[4/3] relative rounded-[2rem] overflow-hidden bg-[#10110F] group border border-[#10110F]/10 dark:border-white/10 shadow-2xl">
              ...
              {/* Card 3 */}
              <div className="mission-card w-full aspect-square sm:aspect-[4/3] relative rounded-[2rem] overflow-hidden bg-gradient-to-br from-[#C7FF00] to-[#9acc00] group shadow-2xl">
