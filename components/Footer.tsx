        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-y-12 gap-x-4 md:gap-8 mb-16 md:mb-32">
          ...
          <div className="col-span-2 md:col-span-5 flex flex-col justify-between">
            ...
            <div className="flex gap-4">
              <a className="w-14 h-14 bg-surface-container border border-white/5 flex items-center justify-center text-on-surface hover:bg-primary hover:text-black hover:border-primary transition-all duration-300 shadow-lg group" href="#" aria-label="Instagram">
              ...
              <a className="w-14 h-14 bg-surface-container border border-white/5 flex items-center justify-center text-on-surface hover:bg-primary hover:text-black hover:border-primary transition-all duration-300 shadow-lg group" href="#" aria-label="Twitter">
